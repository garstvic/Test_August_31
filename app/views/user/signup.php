                ...
                <div class="card-body">
                    ...
                    <form action="<?=URLROOT;?>/index.php?url=user/signup" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input id="confirm_password" type="password" name="name" class="form-control form-control-lg <?php if(!empty($data['confirm_password_err'])){?>is-invalid<?php }?>" value="<?=$data['confirm_password'];?>"/>
